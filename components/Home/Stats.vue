    ...
    <HomeContainer>
      ...
      >
        ...
        <div class="md:7/12 lg:w-1/2">
          ...
          >
            Tech-Enhanced Library Management
          </h2>
          <p class="my-8 text-gray-600 dark:text-gray-300">
            Our library prioritizes technology integration for streamlined
            operations, ensuring an innovative and user-friendly experience for
